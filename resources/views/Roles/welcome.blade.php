...
<section>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <h2 class="testimonial-text" style="font-family: 'Akaya Telivigala', cursive;">Welcome to Naughty dogs vet clinic!, where pet love and human compassion meet.<br>To check your pets profile and history , Please Login.</h2>
